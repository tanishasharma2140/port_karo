            ...
            markers: {
              Marker(
                ...
                infoWindow: InfoWindow(
                  ...
                  snippet: selectedLocation, // Use current selectedLocation
                ),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      TextConst(
                        title: selectedLocation, // Use current selectedLocation
                        color: PortColor.black,
                        fontFamily: AppFonts.poppinsReg,
                        size: 13,
                      ),
        ...
        child: GestureDetector(
            onTap: () {
              if (nameController.text.isEmpty) {
                ...
                // Determine order type and pickup time details
                int orderType = _isNowSelected ? 1 : 2;
                String? pickupDate;
                String? pickupTime;

                if (!_isNowSelected && _selectedDate != null && _selectedTime != null) {
                  pickupDate =
                ...
                print("🟢 Order Type: ${orderType == 1 ? 'Now' : 'Schedule'}");
                if (orderType == 2) {
                ...
                final data = {
                  ...
                  if (orderType == 2) "pickup_date": pickupDate,
                  if (orderType == 2) "pickup_time": pickupTime,
                };
